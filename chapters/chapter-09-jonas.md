...
I arrived eight minutes early, which is what I do when I'm genuinely interested in something and willing to admit it, at least to the logistics. Iris was already inside, talking to two people with lanyards — the particular focused attention of someone navigating the gap between press and not-yet-seated. She saw me when I came through the door, a small lift of the hand: *one moment*, and then she was back.

I found two seats in the fourth row. I put my coat on the one beside me, which is a social convention I am usually too self-conscious to perform and which I performed without deciding to.
...
I asked about the transparency piece. She told me about the four cities — which was serious and which was performing seriousness, and how you could tell the difference from audit structure rather than stated policy. I asked which city was performing. She told me, and the reason, and she was right, and we argued about the third city for half a block before she conceded the audit language was ambiguous in the way she'd suspected but hadn't confirmed.

At some point I noticed we had walked considerably further than either of our apartments required.

---

We stopped at the corner where she turned east and I continued north — or would continue; I hadn't decided. It had started to rain: the particular Berlin January kind that doesn't commit but persists, a fine and relentless kind that by the time you think to mention it has already made its point.
...
There is a kind of moment that presents itself as ordinary and is in fact a question. I recognized it as a question. I also recognized that the question deserved a considered answer, and the considered answer wasn't available yet — not because the data was insufficient but because I hadn't finished understanding what the data was. Forcing a conclusion on incomplete understanding is the specific failure mode I've spent three years building systems to prevent.
...
I walked home in the rain that wasn't serious and arrived at the apartment considerably later than I normally arrive on a Wednesday.

Diogenes on the sill. The lamp making its usual argument for the room. I sat in the chair without turning on the computer and let the apartment be quiet for a while.
